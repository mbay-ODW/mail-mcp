...
def create_mock_fetch_response(header_bytes: bytes, body_bytes: Optional[bytes] = None) -> tuple:
    """
    ...
    if body_bytes:
        ...
        return (IMAP_OK, [(b'1 (BODY[HEADER] {' + str(len(header_bytes)).encode() + b'})', header_bytes)])