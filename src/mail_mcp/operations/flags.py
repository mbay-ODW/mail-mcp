...
class EmailFlags:
    ...
    def _validate_uids(self, uids: int | list[int]) -> list[str]:
        """
    ...
    def _store_flags(
        self, folder: str, uids: int | list[int], command: str, flags: str | list[str]
    ) -> bool:
        """
    ...
    def mark_answered(self, folder: str, uids: int | list[int]) -> bool:
        """
    ...
    def unmark_answered(self, folder: str, uids: int | list[int]) -> bool:
        """
    ...
    def mark_deleted(self, folder: str, uids: int | list[int]) -> bool:
        """
    ...
    def unmark_deleted(self, folder: str, uids: int | list[int]) -> bool:
        """
    ...
    def add_custom_flag(self, folder: str, uids: int | list[int], flag: str) -> bool:
        """
    ...
    def remove_custom_flag(self, folder: str, uids: int | list[int], flag: str) -> bool:
        """
    ...
    def get_flags(self, folder: str, uid: int) -> set[str]:
        """
...
def mark_read(connection, folder: str, uids: int | list[int]) -> bool:
    """Mark emails as read."""
    flags = EmailFlags(connection)
    return flags.mark_read(folder, uids)


def mark_unread(connection, folder: str, uids: int | list[int]) -> bool:
    """Mark emails as unread."""
    flags = EmailFlags(connection)
    return flags.mark_unread(folder, uids)


def mark_flagged(connection, folder: str, uids: int | list[int]) -> bool:
    """Mark emails as flagged."""
    flags = EmailFlags(connection)
    return flags.mark_flagged(folder, uids)


def unmark_flagged(connection, folder: str, uids: int | list[int]) -> bool:
