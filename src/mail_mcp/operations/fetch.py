...
class EmailFetch:
    ...
    def _parse_fetch_response(
        self, response: tuple, uid: int, decode_bodies: bool = True
    ) -> dict[str, Any]:
        """
    ...
    def _extract_attachment(self, part: Message) -> dict[str, Any] | None:
        """
    ...
    def get_headers(self, folder: str, uid: int) -> dict[str, str]:
        """
    ...
    def get_attachment_info(self, folder: str, uid: int) -> list[dict[str, Any]]:
        """
